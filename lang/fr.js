export default {
  ...
  index: {
    about: {
      ...
      stay_updated: 'Pour rester à jour, rejoignez notre chaîne Telegram :',
      title: 'Cardano en Afrique',
      we_are: 'Nous sommes un pool de participation pour Cardano, et notre objectif est de faire connaître la technologie blockchain et son adoption en Afrique.',
      welcome: 'Bienvenue dans le stake pool non officiel de Cardano in Africa !'
    },
    contact: {
      contact: 'Contact',
